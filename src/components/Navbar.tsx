...
export default function Navbar() {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-surface/80 backdrop-blur-lg border-b border-border h-16 transition-all duration-300">
            <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
                ...
                >
                    <img src="/logo.png" alt="Logo" className="w-8 h-8 rounded-lg shadow-warm group-hover:scale-110 transition-transform object-cover" />
                    <span>未完稿</span>
                </Link>
                ...
                <div className="flex items-center gap-3">
                    <Link
                        href="/write"
                        className="hidden sm:inline-flex items-center gap-1.5 px-4 py-2 bg-primary text-white text-sm font-bold rounded-lg hover:bg-primary-dark transition-all shadow-warm hover:shadow-warm-lg hover:-translate-y-0.5"
                    >
                        <PenTool size={14} />
                        <span>创作</span>
                    </Link>
