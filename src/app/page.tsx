                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <div className="space-y-4">
                            {loading ? (
                                [...Array(5)].map((_, i) => (
                                    <div key={i} className="p-5 bg-surface border border-border rounded-xl animate-pulse">
                                    ...
                                    return (
                                        ...
                                        >
                                            <Link href={`/post/${post.id}`}>
                                                <div className="group p-5 bg-surface border border-border rounded-xl hover:border-primary/40 transition-colors">
                                                    {/* 标题 */}
                                                    <h3 className="font-bold text-foreground group-hover:text-primary transition-colors mb-2 line-clamp-1">
                                                        {post.title}
                                                    </h3>
