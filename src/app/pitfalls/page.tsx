...
export default function PitfallsPage() {
    ...
    return (
        <div className="min-h-screen bg-background relative selection:bg-warning/20 selection:text-warning pb-20">
            {/* Header */}
            <header className="relative z-10 pt-24 pb-10 px-6 max-w-4xl mx-auto">
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    className="mb-8"
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-warning/10 text-warning rounded-full text-xs font-bold mb-4 border border-warning/20">
