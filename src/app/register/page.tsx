...
import { ArrowLeft, Sparkles, User, Mail, Lock, Eye, EyeOff } from 'lucide-react';
                ...
                <div className="relative flex flex-col items-center justify-center min-h-screen w-full p-4">
                    ...
                    >
                        ...
                        <div className="text-center mb-6">
                            <img src="/logo.png" alt="Logo" className="w-12 h-12 rounded-xl mb-4 shadow-lg shadow-primary/20 rotate-[-3deg] transform hover:rotate-[-6deg] transition-transform object-cover" />
                            <h1 className="text-2xl font-serif font-bold text-foreground mb-1">加入未完稿</h1>
                            <p className="text-muted text-sm">开启你的创作之旅，记录每一个灵感</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div className="space-y-1.5">
                                <label className="block text-xs font-bold text-foreground pl-1">用户名</label>
                                <div className="relative group">
                                    <User size={16} className="absolute left-4 top-1/2 -translate-y-1/2 text-muted-light group-focus-within:text-primary transition-colors z-10" />
                                    <input
                                        type="text"
                                        required
                                        placeholder="优美的笔名"
                            ...
                            <div className="space-y-1.5">
                                <label className="block text-xs font-bold text-foreground pl-1">密码</label>
                                <div className="relative group">
