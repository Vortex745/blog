...
export default function AboutPage() {
    ...
    return (
        <div className="min-h-screen bg-background relative overflow-hidden">
            ...
            {/* Header */}
            <header className="pt-32 pb-16 px-6 max-w-3xl mx-auto relative z-10">
                <motion.div
                ...
                >
                    ...
                    <div className="flex-1">
                        <div className="inline-flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-primary/10 to-accent/10 text-primary rounded-full text-xs font-bold mb-3 border border-primary/10">
                            <Coffee size={12} />
                            博主
                        </div>
