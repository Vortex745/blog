...
export default function ArchivePage() {
    ...
    return (
        <div className="min-h-screen bg-background relative selection:bg-primary/20 selection:text-primary pb-20">
            <main className="pt-24 pb-16 px-6 max-w-3xl mx-auto relative z-10">
                {/* Header */}
                <motion.div
                    ...
                    className="mb-12"
                >
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/5 border border-primary/10 text-primary rounded-full text-xs font-bold mb-4">
                        <Archive size={12} />
                        时间轴
                    </div>
